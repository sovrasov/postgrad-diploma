...
\newcommand{\cs}[1]{\section*{#1}\addcontentsline{toc}{section}{#1}}
\newcommand{\css}[1]{\subsection*{#1}\addcontentsline{toc}{subsection}{#1}}
...
%\newpage
%\nocite{*}
\addcontentsline{toc}{section}{Список публикаций в изданиях, индексируемых Scopus}
\printbibliography[title={Список публикаций в изданиях, индексируемых Scopus}]
